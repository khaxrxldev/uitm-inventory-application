	...
	<div class="content p-3">
		...
		<div class="card mb-2 w-100">
			...
			<div class="card-body">
				<div class="container">
					<div class="row g-5">
						<form action="Add_supplier_Servlet" method="post" class="needs-validation" novalidate>
							...
							<div class="row g-3">
								<div class="col-6">
									...
									<input name="supplier_idnum" type="text" class="form-control" required>
									<div class="invalid-feedback"> ID number is required. </div>
								</div>
								<div class="col-6">
									<label class="form-label">Name</label>
									<input style="text-transform: capitalize;" name="supplier_name" type="text" class="form-control" required>
									<div class="invalid-feedback"> Name is required. </div>
								</div>
								<div class="col-6">
									<label class="form-label">Phone number</label>
									<input name="supplier_phonenum" type="text" class="form-control">
									<div class="invalid-feedback"> Phone number is required. </div>
								</div>
								<div class="col-6">
									<label class="form-label">Email</label>
									<input name="supplier_email" type="email" class="form-control">
									<div class="invalid-feedback"> Email is required. </div>
								</div>
								<div class="col-12">
									<label class="form-label">Address</label>
									<textarea name="supplier_address" class="form-control" rows="5" style="resize: none;"></textarea>
		...
		<div class="card w-100">
			<div class="card-header fw-bold">Supplier List</div>
			<div class="card-body">
				<table id="example" class="display" style="width:100%">
					...
					<tbody>
						<c:forEach items="${supplierlist}" var="suplist">
							<tr>
								<td><c:out value="${suplist.supplier_idnum}"></c:out></td>
								<td><c:out value="${suplist.supplier_name}"></c:out></td>
								<td><c:out value="${suplist.supplier_phonenum}"></c:out></td>
								<td><c:out value="${suplist.supplier_email}"></c:out></td>
								<td><c:out value="${suplist.supplier_address}"></c:out></td>
								<td>
									<button onclick="window.location.href='Redirect_Servlet?action=supplier_update&id=<c:out value="${suplist.supplier_idnum}"></c:out>'" class="btn btn-sm m-1 btn-secondary" style="border: none;"><img src="assets/icons/edit_white.svg" class="py-1"></button>
									<button onclick="window.location.href='Redirect_Servlet?action=supplier_delete&id=<c:out value="${suplist.supplier_idnum}"></c:out>'" class="btn btn-sm m-1 btn-danger" style="border: none;"><img src="assets/icons/delete_white.svg" class="py-1"></button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
