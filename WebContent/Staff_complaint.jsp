		...
		<div class="card w-100">
			...
			<div class="card-body">
				<div class="container mb-5">
					<div class="row g-5">
						<form action="Complaint_Servlet" method="post" class="needs-validation" novalidate>
							<div class="row g-3">
								<div class="col-3"></div>
								<div class="col-6">
								...
								<div class="col-6">
									<ul class="list-group">
										<li class="list-group-item">
											<input name="graph_complaint_status" value="true" class="form-check-input mx-1" type="checkbox">
											<label class="form-check-label"> Complaint Status Graph</label>
										</li>
									</ul>
								</div>
								<div class="col-3"></div>
				...
				<table id="example" class="display" style="width:100%">
					...
					<tbody>
						<c:forEach items="${complaintlist}" var="complist">
							<tr>
								<td>
									<c:out value="${complist.location_idnum}"></c:out>
								</td>
								<td>
									<c:out value="${complist.complaint_name}"></c:out><br>
								...
								<td>
									<button onclick="window.location.href='Redirect_Servlet?action=complaint_update&id=<c:out value="${complist.complaint_id}"></c:out>'" class="btn btn-sm m-1 btn-secondary" style="border: none;"><img src="assets/icons/edit_white.svg" class="py-1"></button>
									<button onclick="window.location.href='Redirect_Servlet?action=complaint_delete&id=<c:out value="${complist.complaint_id}"></c:out>'" class="btn btn-sm m-1 btn-danger" style="border: none;"><img src="assets/icons/delete_white.svg" class="py-1"></button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
