...
<body>
	<div class="sidebar p-3 bg-accent">
		...
		<ul class="mt-4 nav nav-pills flex-column mb-auto">
			...
			<li>
				<a href="Redirect_Servlet?action=department" class="nav-link active">
					<img src="assets/icons/building_white.svg" class="pb-1 px-2">
	...
	<div class="content p-3">
		...
		<div class="py-3 fs-3 fw-bold">Department</div>
		<div class="card mb-2 w-100">
			<div class="card-header fw-bold">Add Department</div>
			<div class="card-body">
				<div class="container">
					<div class="row g-5">
						<form action="Add_department_Servlet" method="post" class="needs-validation" novalidate>
							...
							<div class="row g-3">
								<div class="col-6">
									...
									<input name="department_idnum" type="text" class="form-control" required>
								...
								<div class="col-12">
									...
									<input style="text-transform: capitalize;" name="department_name" type="text" class="form-control" required>
				...
				<table id="example" class="display" style="width:100%">
					...
					<tbody>
						<c:forEach items="${departmentlist}" var="deptlist">
							<tr>
								<td><c:out value="${deptlist.department_idnum}"></c:out></td>
								<td><c:out value="${deptlist.department_name}"></c:out></td>
								<td>
									<c:out value="${deptlist.location_idnum}"></c:out><br>
									<label class="text-black-50"><c:out value="${deptlist.location.location_block}"></c:out></label><br>
									<label class="text-black-50"><c:out value="${deptlist.location.location_level}"></c:out></label>
								</td>
								<td>
									<button onclick="window.location.href='Redirect_Servlet?action=department_delete&id=<c:out value="${deptlist.department_idnum}"></c:out>'" class="btn btn-sm m-1 btn-danger" style="border: none;"><img src="assets/icons/delete_white.svg" class="py-1"></button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
